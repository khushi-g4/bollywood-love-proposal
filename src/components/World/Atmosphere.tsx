    ...
    <>
      ...
      <group ref={cloudBank}>
        <Clouds limit={segments * 4} range={40}>
          ...
          <Cloud seed={71} bounds={[3.9, 0.45, 0.6]} position={[3.35, 1.18, -3.55]} segments={Math.floor(segments * 0.55)} volume={1.75} smallestVolume={0.18} growth={3} speed={0.012} fade={8} opacity={0.16} color="#c9d8f3" />
        </Clouds>
      </group>
